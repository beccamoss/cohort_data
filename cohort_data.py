    ...
    for line in hogwarts_data:
        ...
        if entity[4] != "I":
            # import pdb; pdb.set_trace()
                # n runs a next line
                # c completes up the next function
            if entity[4] == "Winter 2016":
                winter_16.append(entity[0] + " " + entity[1])
            elif entity[4] == "Spring 2016":
                spring_16.append(entity[0] + " " + entity[1])
            elif entity[4] == "Summer 2016":
                summer_16.append(entity[0] + " " + entity[1])
            elif entity[4] == "Fall 2015":
                fall_15.append(entity[0] + " " + entity[1])
            else:
                ghosts.append(entity[0] + " " + entity[1])
...
def hogwarts_by_house(filename):
    ...
    for line in hogwarts_data:
        ...
        if entity[2]:
            if entity[2] == "Hufflepuff":
                hufflepuff.append(entity[1])
            elif entity[2] == "Gryffindor":
                gryffindor.append(entity[1])
            elif entity[2] == "Ravenclaw":
                ravenclaw.append(entity[1])
            elif entity[2] == "Slytherin":
                slytherin.append(entity[1])
            elif entity[2] == "Dumbledore's Army":
                dumbledores_army.append(entity[1])
        elif entity[4] == "G":
            ghosts.append(entity[1])
        elif entity[4] == "I":
            instructors.append(entity[1])
    # fix order
